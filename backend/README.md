...
The API for the scheduling platform _Plancake_.

## Project Setup

_(Run all commands from the root directory)_
...
<sub>_The name of this repository was not our choice. IT declined our request for a name change because it was "too long" and "irrelevant"._</sub>
...
- Breaking the code in one place breaks it **_EVERYWHERE!_**
...
> **_IMPORTANT - Make sure you use `logger.debug` instead of `logging.debug`. It's a very easy mistake to make, and will result in no information being captured._**
...
_Just remember, well-documented code could keep you looking 20 at 80!_<sup>[Citation needed.]</sup>
