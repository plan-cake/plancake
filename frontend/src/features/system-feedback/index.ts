...
export { default as ConfirmationDialog } from "@/features/system-feedback/dialog/confirmation";
export { default as FormDialog } from "@/features/system-feedback/dialog/form";
